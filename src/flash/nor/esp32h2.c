...
#include "../../../contrib/loaders/flash/espressif/esp32h2/stub_flasher_image_wlog.h"
...
static const uint8_t s_esp32h2_flasher_stub_code[] = {
#include "../../../contrib/loaders/flash/espressif/esp32h2/stub_flasher_code.inc"
};
static const uint8_t s_esp32h2_flasher_stub_data[] = {
#include "../../../contrib/loaders/flash/espressif/esp32h2/stub_flasher_data.inc"
};
static const uint8_t s_esp32h2_flasher_stub_code_wlog[] = {
#include "../../../contrib/loaders/flash/espressif/esp32h2/stub_flasher_code_wlog.inc"
};
static const uint8_t s_esp32h2_flasher_stub_data_wlog[] = {
#include "../../../contrib/loaders/flash/espressif/esp32h2/stub_flasher_data_wlog.inc"
};

static const struct esp_flasher_stub_config s_esp32h2_stub_cfg = {
	.code = s_esp32h2_flasher_stub_code,
	.code_sz = sizeof(s_esp32h2_flasher_stub_code),
	.data = s_esp32h2_flasher_stub_data,
	.data_sz = sizeof(s_esp32h2_flasher_stub_data),
	.entry_addr = ESP32H2_STUB_ENTRY_ADDR,
	.bss_sz = ESP32H2_STUB_BSS_SIZE,
	.iram_org = ESP32H2_STUB_IRAM_ORG,
	.iram_len = ESP32H2_STUB_IRAM_LEN,
	.dram_org = ESP32H2_STUB_DRAM_ORG,
	.dram_len = ESP32H2_STUB_DRAM_LEN,
	.first_user_reg_param = ESP_RISCV_STUB_ARGS_FUNC_START,
	.apptrace_ctrl_addr = ESP32H2_STUB_APPTRACE_CTRL_ADDR,
	.stack_data_pool_sz = ESP_RISCV_STACK_DATA_POOL_SIZE
};

static const struct esp_flasher_stub_config s_esp32h2_stub_cfg_wlog = {
	.code = s_esp32h2_flasher_stub_code_wlog,
	.code_sz = sizeof(s_esp32h2_flasher_stub_code_wlog),
	.data = s_esp32h2_flasher_stub_data_wlog,
	.data_sz = sizeof(s_esp32h2_flasher_stub_data_wlog),
	.entry_addr = ESP32H2_STUB_WLOG_ENTRY_ADDR,
	.bss_sz = ESP32H2_STUB_WLOG_BSS_SIZE,
	.iram_org = ESP32H2_STUB_IRAM_ORG,
	.iram_len = ESP32H2_STUB_IRAM_LEN,
	.dram_org = ESP32H2_STUB_DRAM_ORG,
	.dram_len = ESP32H2_STUB_DRAM_LEN,
	.first_user_reg_param = ESP_RISCV_STUB_ARGS_FUNC_START,
	.apptrace_ctrl_addr = ESP32H2_STUB_WLOG_APPTRACE_CTRL_ADDR,
	.stack_data_pool_sz = ESP_RISCV_STACK_DATA_POOL_SIZE,
	.log_buff_addr = ESP32H2_STUB_WLOG_LOG_ADDR,
	.log_buff_size = ESP32H2_STUB_WLOG_LOG_SIZE
};
...
static const struct esp_flasher_stub_config *esp32h2_get_stub(struct flash_bank *bank)
{
	struct esp_flash_bank *esp_info = bank->driver_priv;
	if (esp_info->stub_log_enabled)
		return &s_esp32h2_stub_cfg_wlog;
	return &s_esp32h2_stub_cfg;
}
