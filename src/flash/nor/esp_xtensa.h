...
struct esp_xtensa_flash_bank {
    ...
    // Sector size
    uint32_t                    sec_sz;
    // Base address of the bank in the flash, 0 - for HW flash bank, non-zero for special IROM/DROM fake banks
    // Those fake banks are necessary for generating proper memory map for GDB and using flash breakpoints
