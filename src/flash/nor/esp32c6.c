...
static const struct esp_flasher_stub_config s_esp32c6_stub_cfg = {
	.code = s_esp32c6_flasher_stub_code,
	.code_sz = sizeof(s_esp32c6_flasher_stub_code),
	.data = s_esp32c6_flasher_stub_data,
...
static const struct esp_flasher_stub_config s_esp32c6_stub_cfg_wlog = {
	.code = s_esp32c6_flasher_stub_code_wlog,
	.code_sz = sizeof(s_esp32c6_flasher_stub_code_wlog),
	.data = s_esp32c6_flasher_stub_data_wlog,
	...
	.stack_data_pool_sz = ESP_RISCV_STACK_DATA_POOL_SIZE,
	.log_buff_addr = ESP32C6_STUB_WLOG_LOG_ADDR,
	.log_buff_size = ESP32C6_STUB_WLOG_LOG_SIZE
};
...
static const struct esp_flasher_stub_config *esp32c6_get_stub(struct flash_bank *bank)
{
	struct esp_flash_bank *esp_info = bank->driver_priv;
	if (esp_info->stub_log_enabled)
		return &s_esp32c6_stub_cfg_wlog;
	return &s_esp32c6_stub_cfg;
}
