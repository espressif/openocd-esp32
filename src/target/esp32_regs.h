//Generated with esp32-genreg.sh
...
//them. The enum and esp32_regs structs should be in the same order.
...
static const struct esp32_reg_desc esp32_regs[XT_NUM_REGS] = {
