...
struct esp_xtensa_special_breakpoint_ops {
    int (*breakpoint_add)(struct target *target, struct breakpoint *breakpoint, struct esp_xtensa_special_breakpoint *spec_bp);
    int (*breakpoint_remove)(struct target *target, struct esp_xtensa_special_breakpoint *spec_bp);
};
...
static inline struct esp_xtensa_common *
target_to_esp_xtensa(struct target *target)
{
    return container_of(target->arch_info, struct esp_xtensa_common, xtensa);
}

int esp_xtensa_init_arch_info(struct target *target, struct target *chip_target, const struct xtensa_config *xtensa_cfg,
