 ...
 */
#define ESP32C61_PMA_ENTRY_NUM                   16
#define ESP32C61_PMA_ENTRY_RAM                   (ESP32C61_PMA_ENTRY_NUM - 2)
#define ESP32C61_PMA_RAM_NAPOT_ADDR              0x1020FFFFUL
#define ESP32C61_PMA_RAM_NAPOT_CFG_RWX           0xC000001DUL

static const struct esp_riscv_pma_entry esp32c61_stub_pma_entry = {
	.index      = ESP32C61_PMA_ENTRY_RAM,
	.napot_addr = ESP32C61_PMA_RAM_NAPOT_ADDR,
	.napot_cfg  = ESP32C61_PMA_RAM_NAPOT_CFG_RWX,
};
...
static int esp32c61_target_create(struct target *target)
{
	...
	esp_riscv->stub_pma_entry = &esp32c61_stub_pma_entry;
