 ...
 *   pmaaddr14 = (0x2F000000 | 0x3FFFF) >> 2 = 0x0BC0FFFF
...
static const struct esp_riscv_pma_entry esp32s31_stub_pma_entry = {
	.index      = ESP32S31_PMA_ENTRY_RAM,
	.napot_addr = ESP32S31_PMA_RAM_NAPOT_ADDR,
	.napot_cfg  = ESP32S31_PMA_RAM_NAPOT_CFG_RWX,
};
...
static int esp32s31_target_create(struct target *target)
{
	...
	esp_riscv->stub_pma_entry = &esp32s31_stub_pma_entry;
