...
#ifndef OPENOCD_LOADERS_FLASH_ESPRESSIF_ESP32C61_SDKCONFIG_H
#define OPENOCD_LOADERS_FLASH_ESPRESSIF_ESP32C61_SDKCONFIG_H
...
#define CONFIG_ESP32C61_DEFAULT_CPU_FREQ_MHZ            160
