function(validate_esp_target ESP_TARGET)
    ...
    set(VALID_TARGETS ${XTENSA_TARGETS} ${RISCV_TARGETS})
...
function(setup_toolchain ESP_TARGET XTENSA_TARGETS)
    if(ESP_TARGET IN_LIST XTENSA_TARGETS)
        ...
        set(TARGET_LINKER_FLAGS ${XTENSA_LINKER_FLAGS} PARENT_SCOPE)
    else()
        ...
        set(TARGET_LINKER_FLAGS ${RISCV_LINKER_FLAGS} PARENT_SCOPE)
    endif()
endfunction()
