...
#define ESP_STUB_FLASH_WITH_LOG_ENTRY_ADDR 0x040381a80UL
#define ESP_STUB_FLASH_WITH_LOG_APPTRACE_CTRL_ADDR 0x03fca5274UL
#define ESP_STUB_FLASH_WITH_LOG_LOG_ADDR 0x03fca5398UL
