...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x40810a38UL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x40814998UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x408149a4UL
