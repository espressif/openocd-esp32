...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x40800a38UL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x40804998UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x408049a4UL
