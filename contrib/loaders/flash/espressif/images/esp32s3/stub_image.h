...
#define ESP_STUB_CMD_TEST1_BSS_SIZE 0x00009dUL
...
#define ESP_STUB_CMD_TEST1_ENTRY_ADDR 0x4038c250UL
...
#define ESP_STUB_CMD_TEST1_TRAP_RECORD_ADDR 0x3fca0088UL
#define ESP_STUB_CMD_TEST1_TRAP_ENTRY_ADDR 0x4038cc00UL

static const uint8_t s_esp_flasher_stub_cmd_test1_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_test1_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_test1_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_test1_data.inc"
};
...
#define ESP_STUB_CMD_RECV_FROM_HOST_ENTRY_ADDR 0x4038c4f4UL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_TRAP_RECORD_ADDR 0x3fca0098UL
#define ESP_STUB_CMD_RECV_FROM_HOST_TRAP_ENTRY_ADDR 0x4038cc00UL

static const uint8_t s_esp_flasher_stub_cmd_recv_from_host_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_recv_from_host_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_recv_from_host_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_recv_from_host_data.inc"
};
...
#define ESP_STUB_CMD_SEND_TO_HOST_ENTRY_ADDR 0x4038c534UL
...
#define ESP_STUB_CMD_SEND_TO_HOST_TRAP_RECORD_ADDR 0x3fca0098UL
#define ESP_STUB_CMD_SEND_TO_HOST_TRAP_ENTRY_ADDR 0x4038cc00UL

static const uint8_t s_esp_flasher_stub_cmd_send_to_host_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_send_to_host_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_send_to_host_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_send_to_host_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_READ_BSS_SIZE 0x0000f8UL
...
#define ESP_STUB_CMD_FLASH_READ_ENTRY_ADDR 0x4038c648UL
...
#define ESP_STUB_CMD_FLASH_READ_TRAP_RECORD_ADDR 0x3fca0094UL
#define ESP_STUB_CMD_FLASH_READ_TRAP_ENTRY_ADDR 0x4038d000UL

static const uint8_t s_esp_flasher_stub_cmd_flash_read_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_read_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_read_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_read_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_ENTRY_ADDR 0x4038c984UL
...
#define ESP_STUB_CMD_FLASH_WRITE_TRAP_RECORD_ADDR 0x3fca0094UL
#define ESP_STUB_CMD_FLASH_WRITE_TRAP_ENTRY_ADDR 0x4038d400UL

static const uint8_t s_esp_flasher_stub_cmd_flash_write_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_write_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_write_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_write_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_BSS_SIZE 0x00009dUL
...
#define ESP_STUB_CMD_FLASH_ERASE_ENTRY_ADDR 0x4038c4c4UL
...
#define ESP_STUB_CMD_FLASH_ERASE_TRAP_RECORD_ADDR 0x3fca008cUL
#define ESP_STUB_CMD_FLASH_ERASE_TRAP_ENTRY_ADDR 0x4038cc00UL

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_erase_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_erase_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_BSS_SIZE 0x0000ccUL
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_ENTRY_ADDR 0x4038c418UL
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_TRAP_RECORD_ADDR 0x3fca0094UL
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_TRAP_ENTRY_ADDR 0x4038cc00UL

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_check_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_erase_check_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_check_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_erase_check_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MAP_GET_BSS_SIZE 0x0000c9UL
...
#define ESP_STUB_CMD_FLASH_MAP_GET_ENTRY_ADDR 0x4038c5d4UL
...
#define ESP_STUB_CMD_FLASH_MAP_GET_TRAP_RECORD_ADDR 0x3fca0090UL
...
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_map_get_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_map_get_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_map_get_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_SET_BSS_SIZE 0x0000cbUL
...
#define ESP_STUB_CMD_FLASH_BP_SET_ENTRY_ADDR 0x4038c998UL
...
#define ESP_STUB_CMD_FLASH_BP_SET_TRAP_RECORD_ADDR 0x3fca0090UL
...
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_bp_set_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_set_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_bp_set_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_BSS_SIZE 0x0000cbUL
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_ENTRY_ADDR 0x4038c960UL
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_TRAP_RECORD_ADDR 0x3fca0090UL
#define ESP_STUB_CMD_FLASH_BP_CLEAR_TRAP_ENTRY_ADDR 0x4038d000UL

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_clear_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_bp_clear_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_clear_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_bp_clear_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_ENTRY_ADDR 0x4038c988UL
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_TRAP_RECORD_ADDR 0x3fca00a0UL
...
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_write_deflated_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_write_deflated_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_write_deflated_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_BSS_SIZE 0x0001a4UL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_ENTRY_ADDR 0x4038c4b4UL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_TRAP_RECORD_ADDR 0x3fca0090UL
#define ESP_STUB_CMD_FLASH_CALC_HASH_TRAP_ENTRY_ADDR 0x4038cc00UL

static const uint8_t s_esp_flasher_stub_cmd_flash_calc_hash_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_calc_hash_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_calc_hash_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_calc_hash_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_BSS_SIZE 0x00009dUL
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_ENTRY_ADDR 0x4038c24cUL
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_TRAP_RECORD_ADDR 0x3fca0098UL
...
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_clock_configure_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_clock_configure_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_clock_configure_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_BSS_SIZE 0x0000cbUL
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_ENTRY_ADDR 0x4038cd90UL
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_TRAP_RECORD_ADDR 0x3fca00ccUL
...
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_multi_command_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_multi_command_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_multi_command_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_BSS_SIZE 0x0000cbUL
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_ENTRY_ADDR 0x4038cd90UL
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_TRAP_RECORD_ADDR 0x3fca00ccUL
...
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_idf_binary_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_idf_binary_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_flash_idf_binary_data.inc"
};
...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x4038e5e8UL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x0UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x3fca1ae4UL
#define ESP_STUB_CMD_TEST_ALL_LOG_SIZE 0x8196UL
#define ESP_STUB_CMD_TEST_ALL_TRAP_RECORD_ADDR 0x3fca1a48UL
#define ESP_STUB_CMD_TEST_ALL_TRAP_ENTRY_ADDR 0x4038f000UL

static const uint8_t s_esp_flasher_stub_cmd_test_all_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_test_all_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_test_all_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_test_all_data.inc"
};
