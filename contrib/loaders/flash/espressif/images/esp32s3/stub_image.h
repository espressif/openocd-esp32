...
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_all_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_all_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s3/stub_cmd_all_data.inc"
};
