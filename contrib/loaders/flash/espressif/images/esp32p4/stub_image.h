...
#define ESP_STUB_CMD_TEST1_BSS_SIZE 0x000090UL
...
#define ESP_STUB_CMD_TEST1_ENTRY_ADDR 0x8ff80056UL
...
#define ESP_STUB_CMD_TEST1_TRAP_RECORD_ADDR 0x8ff8405cUL
#define ESP_STUB_CMD_TEST1_TRAP_ENTRY_ADDR 0x8ff80200UL

static const uint8_t s_esp_flasher_stub_cmd_test1_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_test1_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_test1_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_test1_data.inc"
};
...
#define ESP_STUB_CMD_RECV_FROM_HOST_BSS_SIZE 0x0000d0UL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_ENTRY_ADDR 0x8ff80296UL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_TRAP_RECORD_ADDR 0x8ff8409cUL
...
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_recv_from_host_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_recv_from_host_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_recv_from_host_data.inc"
};
...
#define ESP_STUB_CMD_SEND_TO_HOST_BSS_SIZE 0x0000d1UL
...
#define ESP_STUB_CMD_SEND_TO_HOST_ENTRY_ADDR 0x8ff802e2UL
...
#define ESP_STUB_CMD_SEND_TO_HOST_TRAP_RECORD_ADDR 0x8ff8409cUL
...
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_send_to_host_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_send_to_host_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_send_to_host_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_READ_BSS_SIZE 0x0000d0UL
...
#define ESP_STUB_CMD_FLASH_READ_ENTRY_ADDR 0x8ff8040cUL
...
#define ESP_STUB_CMD_FLASH_READ_TRAP_RECORD_ADDR 0x8ff84098UL
#define ESP_STUB_CMD_FLASH_READ_TRAP_ENTRY_ADDR 0x8ff80600UL

static const uint8_t s_esp_flasher_stub_cmd_flash_read_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_read_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_read_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_read_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_BSS_SIZE 0x0000f0UL
...
#define ESP_STUB_CMD_FLASH_WRITE_ENTRY_ADDR 0x8ff80722UL
...
#define ESP_STUB_CMD_FLASH_WRITE_TRAP_RECORD_ADDR 0x8ff840b0UL
#define ESP_STUB_CMD_FLASH_WRITE_TRAP_ENTRY_ADDR 0x8ff80900UL

static const uint8_t s_esp_flasher_stub_cmd_flash_write_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_write_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_write_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_write_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_BSS_SIZE 0x000092UL
...
#define ESP_STUB_CMD_FLASH_ERASE_ENTRY_ADDR 0x8ff802ceUL
...
#define ESP_STUB_CMD_FLASH_ERASE_TRAP_RECORD_ADDR 0x8ff84060UL
#define ESP_STUB_CMD_FLASH_ERASE_TRAP_ENTRY_ADDR 0x8ff80500UL

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_erase_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_erase_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_BSS_SIZE 0x000092UL
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_ENTRY_ADDR 0x8ff80236UL
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_TRAP_RECORD_ADDR 0x8ff84068UL
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_TRAP_ENTRY_ADDR 0x8ff80400UL

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_check_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_erase_check_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_check_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_erase_check_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MAP_GET_BSS_SIZE 0x000092UL
...
#define ESP_STUB_CMD_FLASH_MAP_GET_ENTRY_ADDR 0x8ff8039eUL
...
#define ESP_STUB_CMD_FLASH_MAP_GET_TRAP_RECORD_ADDR 0x8ff84064UL
#define ESP_STUB_CMD_FLASH_MAP_GET_TRAP_ENTRY_ADDR 0x8ff80600UL

static const uint8_t s_esp_flasher_stub_cmd_flash_map_get_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_map_get_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_map_get_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_map_get_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_SET_BSS_SIZE 0x000094UL
...
#define ESP_STUB_CMD_FLASH_BP_SET_ENTRY_ADDR 0x8ff80686UL
...
#define ESP_STUB_CMD_FLASH_BP_SET_TRAP_RECORD_ADDR 0x8ff84064UL
#define ESP_STUB_CMD_FLASH_BP_SET_TRAP_ENTRY_ADDR 0x8ff80900UL

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_set_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_bp_set_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_set_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_bp_set_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_BSS_SIZE 0x000094UL
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_ENTRY_ADDR 0x8ff80670UL
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_TRAP_RECORD_ADDR 0x8ff84064UL
#define ESP_STUB_CMD_FLASH_BP_CLEAR_TRAP_ENTRY_ADDR 0x8ff80900UL

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_clear_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_bp_clear_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_clear_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_bp_clear_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_BSS_SIZE 0x0000f0UL
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_ENTRY_ADDR 0x8ff80740UL
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_TRAP_RECORD_ADDR 0x8ff840bcUL
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_TRAP_ENTRY_ADDR 0x8ff80900UL

static const uint8_t s_esp_flasher_stub_cmd_flash_write_deflated_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_write_deflated_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_write_deflated_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_write_deflated_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_BSS_SIZE 0x00016aUL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_ENTRY_ADDR 0x8ff80226UL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_TRAP_RECORD_ADDR 0x8ff8413cUL
#define ESP_STUB_CMD_FLASH_CALC_HASH_TRAP_ENTRY_ADDR 0x8ff80400UL

static const uint8_t s_esp_flasher_stub_cmd_flash_calc_hash_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_calc_hash_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_calc_hash_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_calc_hash_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_BSS_SIZE 0x000090UL
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_ENTRY_ADDR 0x8ff80054UL
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_TRAP_RECORD_ADDR 0x8ff8406cUL
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_TRAP_ENTRY_ADDR 0x8ff80200UL

static const uint8_t s_esp_flasher_stub_cmd_flash_clock_configure_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_clock_configure_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_clock_configure_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_clock_configure_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_BSS_SIZE 0x000094UL
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_ENTRY_ADDR 0x8ff80a80UL
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_TRAP_RECORD_ADDR 0x8ff840a4UL
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_TRAP_ENTRY_ADDR 0x8ff80d00UL

static const uint8_t s_esp_flasher_stub_cmd_flash_multi_command_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_multi_command_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_multi_command_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_multi_command_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_BSS_SIZE 0x000094UL
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_ENTRY_ADDR 0x8ff80a80UL
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_TRAP_RECORD_ADDR 0x8ff840a4UL
#define ESP_STUB_CMD_FLASH_IDF_BINARY_TRAP_ENTRY_ADDR 0x8ff80d00UL

static const uint8_t s_esp_flasher_stub_cmd_flash_idf_binary_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_idf_binary_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_idf_binary_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_flash_idf_binary_data.inc"
};
...
#define ESP_STUB_CMD_TEST_ALL_BSS_SIZE 0x0021ccUL
...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x8ff82184UL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x8ff85760UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x8ff858ecUL
#define ESP_STUB_CMD_TEST_ALL_LOG_SIZE 0x8196UL
#define ESP_STUB_CMD_TEST_ALL_TRAP_RECORD_ADDR 0x8ff8586cUL
#define ESP_STUB_CMD_TEST_ALL_TRAP_ENTRY_ADDR 0x8ff82500UL

static const uint8_t s_esp_flasher_stub_cmd_test_all_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_test_all_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_test_all_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32p4/stub_cmd_test_all_data.inc"
};
