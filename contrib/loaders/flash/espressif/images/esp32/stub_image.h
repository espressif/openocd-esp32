...
#define ESP_STUB_CMD_TEST1_ENTRY_ADDR 0x400bc0bcUL
...
#define ESP_STUB_CMD_TEST1_TRAP_RECORD_ADDR 0x3ffe404cUL
#define ESP_STUB_CMD_TEST1_TRAP_ENTRY_ADDR 0x400bc800UL

static const uint8_t s_esp_flasher_stub_test1_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_test1_code.inc"
};

static const uint8_t s_esp_flasher_stub_test1_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_test1_data.inc"
};
...
#define ESP_STUB_CMD_RECV_FROM_HOST_BSS_SIZE 0x0000acUL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_ENTRY_ADDR 0x400bc320UL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_TRAP_RECORD_ADDR 0x3ffe405cUL
#define ESP_STUB_CMD_RECV_FROM_HOST_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_recv_from_host_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_recv_from_host_code.inc"
};

static const uint8_t s_esp_flasher_stub_recv_from_host_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_recv_from_host_data.inc"
};
...
#define ESP_STUB_CMD_SEND_TO_HOST_BSS_SIZE 0x0000adUL
...
#define ESP_STUB_CMD_SEND_TO_HOST_ENTRY_ADDR 0x400bc39cUL
...
#define ESP_STUB_CMD_SEND_TO_HOST_TRAP_RECORD_ADDR 0x3ffe405cUL
#define ESP_STUB_CMD_SEND_TO_HOST_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_send_to_host_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_send_to_host_code.inc"
};

static const uint8_t s_esp_flasher_stub_send_to_host_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_send_to_host_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_READ_BSS_SIZE 0x0000d8UL
...
#define ESP_STUB_CMD_FLASH_READ_ENTRY_ADDR 0x400bc540UL
...
#define ESP_STUB_CMD_FLASH_READ_TRAP_RECORD_ADDR 0x3ffe4058UL
#define ESP_STUB_CMD_FLASH_READ_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_read_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_read_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_read_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_read_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_BSS_SIZE 0x0000ccUL
...
#define ESP_STUB_CMD_FLASH_WRITE_ENTRY_ADDR 0x400bc56cUL
...
#define ESP_STUB_CMD_FLASH_WRITE_TRAP_RECORD_ADDR 0x3ffe4058UL
#define ESP_STUB_CMD_FLASH_WRITE_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_write_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_write_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_write_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_write_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_ENTRY_ADDR 0x400bc22cUL
...
#define ESP_STUB_CMD_FLASH_ERASE_TRAP_RECORD_ADDR 0x3ffe4050UL
#define ESP_STUB_CMD_FLASH_ERASE_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_erase_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_erase_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_erase_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_erase_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_ENTRY_ADDR 0x400bc30cUL
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_TRAP_RECORD_ADDR 0x3ffe4058UL
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_erase_check_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_erase_check_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_erase_check_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_erase_check_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MAP_GET_ENTRY_ADDR 0x400bc488UL
...
#define ESP_STUB_CMD_FLASH_MAP_GET_TRAP_RECORD_ADDR 0x3ffe4054UL
#define ESP_STUB_CMD_FLASH_MAP_GET_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_map_get_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_map_get_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_map_get_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_map_get_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_SET_ENTRY_ADDR 0x400bc55cUL
...
#define ESP_STUB_CMD_FLASH_BP_SET_TRAP_RECORD_ADDR 0x3ffe4054UL
#define ESP_STUB_CMD_FLASH_BP_SET_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_bp_set_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_bp_set_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_bp_set_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_bp_set_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_ENTRY_ADDR 0x400bc530UL
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_TRAP_RECORD_ADDR 0x3ffe4054UL
#define ESP_STUB_CMD_FLASH_BP_CLEAR_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_bp_clear_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_bp_clear_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_bp_clear_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_bp_clear_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_BSS_SIZE 0x0000ccUL
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_ENTRY_ADDR 0x400bc5a0UL
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_TRAP_RECORD_ADDR 0x3ffe4064UL
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_write_deflated_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_write_deflated_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_write_deflated_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_write_deflated_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_BSS_SIZE 0x0000b0UL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_ENTRY_ADDR 0x400bc480UL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_TRAP_RECORD_ADDR 0x3ffe4094UL
#define ESP_STUB_CMD_FLASH_CALC_HASH_TRAP_ENTRY_ADDR 0x400bcc00UL

static const uint8_t s_esp_flasher_stub_flash_calc_hash_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_calc_hash_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_calc_hash_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_calc_hash_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_ENTRY_ADDR 0x400bc0b8UL
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_TRAP_RECORD_ADDR 0x3ffe405cUL
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_TRAP_ENTRY_ADDR 0x400bc800UL

static const uint8_t s_esp_flasher_stub_flash_clock_configure_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_clock_configure_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_clock_configure_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_clock_configure_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_ENTRY_ADDR 0x400bca30UL
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_TRAP_RECORD_ADDR 0x3ffe4090UL
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_TRAP_ENTRY_ADDR 0x400bd400UL

static const uint8_t s_esp_flasher_stub_flash_multi_command_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_multi_command_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_multi_command_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_multi_command_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_ENTRY_ADDR 0x400bca30UL
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_TRAP_RECORD_ADDR 0x3ffe4090UL
#define ESP_STUB_CMD_FLASH_IDF_BINARY_TRAP_ENTRY_ADDR 0x400bd400UL

static const uint8_t s_esp_flasher_stub_flash_idf_binary_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_idf_binary_code.inc"
};

static const uint8_t s_esp_flasher_stub_flash_idf_binary_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_flash_idf_binary_data.inc"
};
...
#define ESP_STUB_CMD_TEST_ALL_BSS_SIZE 0x0020ffUL
...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x400be2e8UL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x0UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x3ffe5a10UL
#define ESP_STUB_CMD_TEST_ALL_LOG_SIZE 0x8196UL
#define ESP_STUB_CMD_TEST_ALL_TRAP_RECORD_ADDR 0x3ffe5990UL
#define ESP_STUB_CMD_TEST_ALL_TRAP_ENTRY_ADDR 0x400bec00UL

static const uint8_t s_esp_flasher_stub_test_all_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_test_all_code.inc"
};

static const uint8_t s_esp_flasher_stub_test_all_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_test_all_data.inc"
};
