...
#define ESP_STUB_CMD_TEST1_ENTRY_ADDR 0x400bc058UL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_ENTRY_ADDR 0x400bc2d8UL
...
#define ESP_STUB_CMD_SEND_TO_HOST_ENTRY_ADDR 0x400bc340UL
...
#define ESP_STUB_CMD_FLASH_INFO_IRAM_ORG 0x400bc000UL
#define ESP_STUB_CMD_FLASH_INFO_IRAM_LEN 0x00004000UL
#define ESP_STUB_CMD_FLASH_INFO_DRAM_ORG 0x3ffe4000UL
#define ESP_STUB_CMD_FLASH_INFO_DRAM_LEN 0x00014000UL
#define ESP_STUB_CMD_FLASH_INFO_ENTRY_ADDR 0x400bc064UL
...
#include "contrib/loaders/flash/espressif/images/esp32/stub_cmd_flash_info_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_info_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_cmd_flash_info_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_TEST_IRAM_ORG 0x400bc000UL
#define ESP_STUB_CMD_FLASH_TEST_IRAM_LEN 0x00004000UL
#define ESP_STUB_CMD_FLASH_TEST_DRAM_ORG 0x3ffe4000UL
#define ESP_STUB_CMD_FLASH_TEST_DRAM_LEN 0x00014000UL
#define ESP_STUB_CMD_FLASH_TEST_ENTRY_ADDR 0x400bc100UL
...
#include "contrib/loaders/flash/espressif/images/esp32/stub_cmd_flash_test_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_test_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32/stub_cmd_flash_test_data.inc"
};
...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x400bcb08UL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x0UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x3ffe49dcUL
