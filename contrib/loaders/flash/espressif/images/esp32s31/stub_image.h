...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_test1_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_test1_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_test1_data.inc"
};
...
#define ESP_STUB_CMD_RECV_FROM_HOST_ENTRY_ADDR 0x2f0002e4UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_recv_from_host_data.inc"
};
...
#define ESP_STUB_CMD_SEND_TO_HOST_ENTRY_ADDR 0x2f000330UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_send_to_host_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_send_to_host_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_send_to_host_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_READ_ENTRY_ADDR 0x2f000564UL
...
#define ESP_STUB_CMD_FLASH_READ_TRAP_RECORD_ADDR 0x2f0040c0UL
#define ESP_STUB_CMD_FLASH_READ_TRAP_ENTRY_ADDR 0x2f000700UL

static const uint8_t s_esp_flasher_stub_cmd_flash_read_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_read_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_read_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_read_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_ENTRY_ADDR 0x2f000590UL
...
#define ESP_STUB_CMD_FLASH_WRITE_TRAP_ENTRY_ADDR 0x2f000700UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_write_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_ENTRY_ADDR 0x2f0002beUL
...
#define ESP_STUB_CMD_FLASH_ERASE_TRAP_ENTRY_ADDR 0x2f000500UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_erase_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_ENTRY_ADDR 0x2f0003a6UL
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_TRAP_RECORD_ADDR 0x2f004090UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_erase_check_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_check_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_erase_check_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MAP_GET_BSS_SIZE 0x0000b8UL
...
#define ESP_STUB_CMD_FLASH_MAP_GET_TRAP_RECORD_ADDR 0x2f00408cUL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_map_get_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_map_get_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_map_get_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_SET_BSS_SIZE 0x0000bcUL
...
#define ESP_STUB_CMD_FLASH_BP_SET_ENTRY_ADDR 0x2f0006deUL
...
#define ESP_STUB_CMD_FLASH_BP_SET_TRAP_RECORD_ADDR 0x2f00408cUL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_bp_set_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_BSS_SIZE 0x0000bcUL
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_ENTRY_ADDR 0x2f0006c0UL
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_TRAP_RECORD_ADDR 0x2f00408cUL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_bp_clear_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_ENTRY_ADDR 0x2f00059eUL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_write_deflated_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_ENTRY_ADDR 0x2f0003b0UL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_TRAP_RECORD_ADDR 0x2f004164UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_calc_hash_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_calc_hash_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_calc_hash_data.inc"
};
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_clock_configure_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_clock_configure_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_clock_configure_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_BSS_SIZE 0x0000bcUL
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_ENTRY_ADDR 0x2f000a8eUL
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_TRAP_RECORD_ADDR 0x2f0040ccUL
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_TRAP_ENTRY_ADDR 0x2f000c00UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_multi_command_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_BSS_SIZE 0x0000bcUL
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_ENTRY_ADDR 0x2f000a8eUL
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_TRAP_RECORD_ADDR 0x2f0040ccUL
#define ESP_STUB_CMD_FLASH_IDF_BINARY_TRAP_ENTRY_ADDR 0x2f000c00UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_flash_idf_binary_data.inc"
};
...
#define ESP_STUB_CMD_TEST_ALL_BSS_SIZE 0x0021f4UL
...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x2f0023baUL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x2f005ac4UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x2f005c78UL
#define ESP_STUB_CMD_TEST_ALL_LOG_SIZE 0x8196UL
#define ESP_STUB_CMD_TEST_ALL_TRAP_RECORD_ADDR 0x2f005bf8UL
#define ESP_STUB_CMD_TEST_ALL_TRAP_ENTRY_ADDR 0x2f002700UL
...
#include "contrib/loaders/flash/espressif/images/esp32s31/stub_cmd_test_all_data.inc"
};
