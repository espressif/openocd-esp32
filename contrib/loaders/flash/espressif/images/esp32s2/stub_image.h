...
#define ESP_STUB_CMD_TEST1_ENTRY_ADDR 0x400280a4UL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_BSS_SIZE 0x0000bcUL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_ENTRY_ADDR 0x40028328UL
...
#define ESP_STUB_CMD_SEND_TO_HOST_BSS_SIZE 0x0000bdUL
...
#define ESP_STUB_CMD_SEND_TO_HOST_ENTRY_ADDR 0x40028384UL
...
#define ESP_STUB_CMD_FLASH_READ_ENTRY_ADDR 0x4002842cUL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_read_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_read_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_read_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_BSS_SIZE 0x0000dcUL
...
#define ESP_STUB_CMD_FLASH_WRITE_ENTRY_ADDR 0x40028628UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_write_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_write_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_write_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_BSS_SIZE 0x000091UL
...
#define ESP_STUB_CMD_FLASH_ERASE_ENTRY_ADDR 0x400282c4UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_erase_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_erase_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_BSS_SIZE 0x000091UL
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_ENTRY_ADDR 0x400281f4UL
...
#define ESP_STUB_CMD_FLASH_ERASE_CHECK_TRAP_ENTRY_ADDR 0x40028800UL

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_check_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_erase_check_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_erase_check_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_erase_check_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MAP_GET_BSS_SIZE 0x000091UL
...
#define ESP_STUB_CMD_FLASH_MAP_GET_ENTRY_ADDR 0x400283c0UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_map_get_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_map_get_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_map_get_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_SET_BSS_SIZE 0x000093UL
...
#define ESP_STUB_CMD_FLASH_BP_SET_ENTRY_ADDR 0x40028508UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_bp_set_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_set_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_bp_set_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_BSS_SIZE 0x000093UL
...
#define ESP_STUB_CMD_FLASH_BP_CLEAR_ENTRY_ADDR 0x400284e4UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_bp_clear_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_bp_clear_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_bp_clear_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_BSS_SIZE 0x0000dcUL
...
#define ESP_STUB_CMD_FLASH_WRITE_DEFLATED_ENTRY_ADDR 0x40028634UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_write_deflated_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_write_deflated_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_write_deflated_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_BSS_SIZE 0x00016cUL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_ENTRY_ADDR 0x4002823cUL
...
#define ESP_STUB_CMD_FLASH_CALC_HASH_TRAP_ENTRY_ADDR 0x40028800UL

static const uint8_t s_esp_flasher_stub_cmd_flash_calc_hash_code[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_calc_hash_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_calc_hash_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_calc_hash_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_CLOCK_CONFIGURE_ENTRY_ADDR 0x4002809cUL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_clock_configure_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_clock_configure_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_clock_configure_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_BSS_SIZE 0x000093UL
...
#define ESP_STUB_CMD_FLASH_MULTI_COMMAND_ENTRY_ADDR 0x40028904UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_multi_command_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_multi_command_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_multi_command_data.inc"
};
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_BSS_SIZE 0x000093UL
...
#define ESP_STUB_CMD_FLASH_IDF_BINARY_ENTRY_ADDR 0x40028904UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_idf_binary_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_idf_binary_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_idf_binary_data.inc"
};
...
#define ESP_STUB_CMD_TEST_ALL_BSS_SIZE 0x0021b8UL
...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x40029ebcUL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x0UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x3ffbd700UL
#define ESP_STUB_CMD_TEST_ALL_LOG_SIZE 0x8196UL
#define ESP_STUB_CMD_TEST_ALL_TRAP_RECORD_ADDR 0x3ffbd67cUL
