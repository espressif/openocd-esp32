...
#define ESP_STUB_CMD_TEST1_ENTRY_ADDR 0x40028058UL
...
#define ESP_STUB_CMD_RECV_FROM_HOST_ENTRY_ADDR 0x400282e4UL
...
#define ESP_STUB_CMD_SEND_TO_HOST_ENTRY_ADDR 0x40028340UL
...
#define ESP_STUB_CMD_FLASH_INFO_IRAM_ORG 0x40028000UL
#define ESP_STUB_CMD_FLASH_INFO_IRAM_LEN 0x00004000UL
#define ESP_STUB_CMD_FLASH_INFO_DRAM_ORG 0x3ffbc000UL
#define ESP_STUB_CMD_FLASH_INFO_DRAM_LEN 0x00020000UL
#define ESP_STUB_CMD_FLASH_INFO_ENTRY_ADDR 0x400280a8UL
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_info_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_info_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_info_data.inc"
};
...
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_test_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_flash_test_data[] = {
#include "contrib/loaders/flash/espressif/images/esp32s2/stub_cmd_flash_test_data.inc"
};
...
#define ESP_STUB_CMD_TEST_ALL_ENTRY_ADDR 0x40028a80UL
#define ESP_STUB_CMD_TEST_ALL_APPTRACE_CTRL_ADDR 0x0UL
#define ESP_STUB_CMD_TEST_ALL_LOG_ADDR 0x3ffbc954UL
