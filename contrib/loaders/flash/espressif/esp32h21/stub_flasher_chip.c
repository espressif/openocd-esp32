...
/***************************************************************************
 *   ESP32-H21 specific flasher stub functions                              *
...
uint32_t g_stub_cpu_freq_hz = CONFIG_ESP32H21_DEFAULT_CPU_FREQ_MHZ * MHZ;
...
uint64_t stub_get_time(void)
{
	/* this function is used for perf measurements only.
		unfortunately esp32h21 does not support CPU cycle counter and usage of HW timer is problematic */
	return 0;
}
