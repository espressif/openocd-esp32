...
#define ESP_STUB_CMD_TEST1_ENTRY_ADDR 0x400bc020UL
...
#include "contrib/loaders/flash/esp-stub-ng/images/esp32/stub_cmd_test1_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_test1_data[] = {
#include "contrib/loaders/flash/esp-stub-ng/images/esp32/stub_cmd_test1_data.inc"
};
...
#define ESP_STUB_CMD_TEST2_IRAM_ORG 0x400bc000UL
#define ESP_STUB_CMD_TEST2_IRAM_LEN 0x00004000UL
#define ESP_STUB_CMD_TEST2_DRAM_ORG 0x3ffe4000UL
#define ESP_STUB_CMD_TEST2_DRAM_LEN 0x00014000UL
#define ESP_STUB_CMD_TEST2_ENTRY_ADDR 0x400bc020UL
...
#include "contrib/loaders/flash/esp-stub-ng/images/esp32/stub_cmd_test2_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_test2_data[] = {
#include "contrib/loaders/flash/esp-stub-ng/images/esp32/stub_cmd_test2_data.inc"
};
...
#define ESP_STUB_CMD_ALL_IRAM_ORG 0x400bc000UL
#define ESP_STUB_CMD_ALL_IRAM_LEN 0x00004000UL
#define ESP_STUB_CMD_ALL_DRAM_ORG 0x3ffe4000UL
#define ESP_STUB_CMD_ALL_DRAM_LEN 0x00014000UL
#define ESP_STUB_CMD_ALL_ENTRY_ADDR 0x400bc0b8UL
...
#include "contrib/loaders/flash/esp-stub-ng/images/esp32/stub_cmd_all_code.inc"
};

static const uint8_t s_esp_flasher_stub_cmd_all_data[] = {
#include "contrib/loaders/flash/esp-stub-ng/images/esp32/stub_cmd_all_data.inc"
};
