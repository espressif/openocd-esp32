...
foreach(COMMAND ${COMMANDS})
    ...
    file(APPEND ${HEADER_FILE}
        ...
        "#include \"contrib/loaders/flash/esp-stub-ng/${IMAGE_DIR}/${ESP_TARGET}/stub_${COMMAND}_code.inc\"\n"
        "};\n\n"
        "static const uint8_t s_esp_flasher_stub_${COMMAND}_data[] = {\n"
        "#include \"contrib/loaders/flash/esp-stub-ng/${IMAGE_DIR}/${ESP_TARGET}/stub_${COMMAND}_data.inc\"\n"
        "};\n\n"
    )
